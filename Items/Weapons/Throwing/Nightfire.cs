...
{
    public class Nightfire : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Nightfire");
            // Tooltip.SetDefault("[c/7C85FF:Don't love me quietly]\r\n[c/7C85FF:Do it with intensity]");
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<NightfireProj>();
            Item.shootSpeed = 20f;
            Item.maxStack = 1;
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<ShadowEssence>(), 6)
